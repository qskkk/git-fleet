...
//
//go:generate go run go.uber.org/mock/mockgen -package=styles -destination=service_mocks.go github.com/qskkk/git-fleet/v2/internal/infrastructure/ui/styles Service
package styles
