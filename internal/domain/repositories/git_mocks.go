...
// Source: github.com/qskkk/git-fleet/v2/internal/domain/repositories (interfaces: GitRepository,ExecutorRepository)
//
// Generated by this command:
//
//	mockgen -package=repositories -destination=git_mocks.go github.com/qskkk/git-fleet/v2/internal/domain/repositories GitRepository,ExecutorRepository
//
