...
//
//	mockgen -package=output -destination=interfaces_mock.go github.com/qskkk/git-fleet/internal/application/ports/output PresenterPort,FormatterPort,WriterPort
//
