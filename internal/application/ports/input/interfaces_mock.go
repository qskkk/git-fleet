...
//
//	mockgen -package=input -destination=interfaces_mock.go github.com/qskkk/git-fleet/internal/application/ports/input CLIPort,InteractivePort,ConfigManager
//
