...
// Source: github.com/qskkk/git-fleet/internal/pkg/logger (interfaces: Service)
//
// Generated by this command:
//
//	mockgen -package=logger -destination=logger_mocks.go github.com/qskkk/git-fleet/internal/pkg/logger Service
//
